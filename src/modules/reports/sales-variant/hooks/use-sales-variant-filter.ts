...
import type { Period } from '../types/sales-variant.types';
...
export function useSalesVariantFilters() {
  ...
  const [filters, setFilters] = useQueryStates({
    ...
    product_variant_id: parseAsString.withDefault(''),
  ...
  return {
    ...
    updateVariant: (product_variant_id: string) => updateWithPageReset({ product_variant_id }),
