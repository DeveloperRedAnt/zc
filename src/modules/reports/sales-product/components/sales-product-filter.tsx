...
export function SalesProductFilter() {
  const { filters, updateStartDate, updateEndDate, updateStore, updateProduct, updatePeriod } =
    useSalesProductFilters();
  ...
  // Ensure the period from query params is a valid PeriodType, otherwise default to 'monthly'
