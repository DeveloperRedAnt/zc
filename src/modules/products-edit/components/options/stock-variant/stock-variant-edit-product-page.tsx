...
export function StockVariantPage({ productData }: StockVariantPageProps) {
  ...
  return (
    <>
      <Card>
        <CardHeader>
          <CardTitle className="text-lg font-semibold mb-4">Atur Stok Awal</CardTitle>
          <div className="mb-6">
          ...
          <h3 className="text-md font-medium mb-4 mt-3">Supplier dan Biaya Lain-Lain (Opsional)</h3>
        </CardHeader>
        <CardContent>
