...
import { DeleteDialog } from '../dialog-options';
    ...
    <FormValidationProvider>
      ...
      {FormattedData[0] && (
        <FormAddVariant
          ...
          onChange={(values) =>
            FormattedData[0] && handleDetailVariantChange(FormattedData[0].id, values)
          }
          errors={fieldErrors?.[FormattedData[0]?.id] ?? {}} // error varian
        />
      )}
